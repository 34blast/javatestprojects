...
public class CreatePDFFromXML2 {
	...
	public void convertToPDF() throws IOException, FOPException, TransformerException {
		...
		// the XSL FO file
		// File xsltFile = new File("C:\\pub\\temp\\employees.xsl");
		// the XML file which provides the input
		// StreamSource xmlSource = new StreamSource(new
		// File("C:\\pub\\temp\\employees.xml"));
	...
	public static void main(String[] args) {
		...
		System.out.println("CreatePDFFromXML2.main() starting execution ");
		System.out.println();

		CreatePDFFromXML2 CreatePDFFromXML = new CreatePDFFromXML2();
		try {
		...
		System.out.println();
		System.out.println("CreatePDFFromXML2.main() stopping execution ");
