...
public class CreatePDFFromXML {
	...
	public void convertToPDF() throws IOException, FOPException, TransformerException {
		...
		StreamSource xmlSource = new StreamSource(new File("C:\\pub\\temp\\employees.xml"));
		...
		// Setup output
		OutputStream out;
		out = new java.io.FileOutputStream("C:\\pub\\temp\\employee.pdf");
	...
	public void convertToFO() throws IOException, FOPException, TransformerException {
		...
		out = new java.io.FileOutputStream("C:\\pub\\temp\\temp.txt");
